...
<body>
    <div class="main-area">
        <section class="left-section" style="
					background-image: url(https://www.verdict.co.uk/wp-content/uploads/2017/11/shutterstock_617032220.jpg);
				"></section>
        <!-- left-section -->

        <section class="right-section full-height">
            <a class="logo" href="#"><img src="https://keymining.ltd/secured/img/logos/logo-2-light.png" alt="Logo" /></a>
            ...
            <div class="display-table">
                <div class="display-table-cell">
                    <div class="main-content">
                        ...
                        <p class="post-desc">Get early notification of our lauch time!</p>
                    </div>
                    <!-- main-content -->
                </div>
                <!-- display-table-cell -->

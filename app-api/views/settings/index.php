			...
			<form method="post" action="" id="form" enctype="multipart/form-data">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="loader"><b>Header Application</b></label>
								<div class="d-flex justify-content-between">
								</div>
							</div>
						</div>
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<img src="../images/settings/<?= $data["logo"] ?>?<?= time() ?>" style="width:100px; background-color: #bdbdbd" id="thumb_img" class="img-thumbnail">
							</div> 
							-->
						</div>
						<!-- /.col -->
